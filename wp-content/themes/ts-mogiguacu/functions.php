...
function twentysixteen_setup() {
	...
	register_nav_menus( array(
		...
		'secondary-menu' => __( 'Menu secundário', 'twentysixteen' ),
        'footer-menu' => __( 'Menu rodapé', 'twentysixteen' ),
	) );
	/*
...
function point_excerpt($string, $substring) {
...
add_image_size( 'banner-internal', 1920, 9999 ); //1920 pixels wide (and unlimited height)
...
add_action('admin_menu', 'my_remove_category');
...
// Pega url da pagina pra exibir no e-mail
