		...
		if ( $post->post_parent == '27' || $post->post_parent == '29' || $post->post_parent == '31' || $post->post_parent == '33' ) :
			...
			if($exibir_materiais){
				...
				if(is_page( 102 )){
					...
					$pdfurls = 'http://tsmogiguacu.com.br/wp-content/uploads/2016/11/PROCEM_TSMG_2019_SET-_.pdf';
				}
		...
		<?php 
			if(is_page("politica-da-qualidade-da-empresa")){
				...
				echo '<ul class="container-politica ">';
					...
					echo '<p><div class="pdf_politica"></p>';
					...
					_e('<span></span>[:pb]Download do Certificado - ISO9001[:][:en]Download Quality Certificate[:]');
